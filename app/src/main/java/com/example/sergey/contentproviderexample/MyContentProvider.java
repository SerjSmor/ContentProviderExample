package com.example.sergey.contentproviderexample;
...
public class MyContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri
            .parse("content://com.example.sergey.contentproviderexample.db/names_amounts");
    public static final Uri SILLY_URI = Uri
            .parse("content://com.example.sergey.contentproviderexample.db/silly_stuff");
    ...
    UriMatcher uriMatcher = null;
    {
        ...
        // return 1 if uri is ...
        uriMatcher.addURI("com.example.sergey.contentproviderexample.db", "names_amounts", 1);

        // return 2 if uri is ...
        uriMatcher.addURI("com.example.sergey.contentproviderexample.db", "silly_stuff", 2);
    }
    @Override
    ...
    public int update(Uri uri, ContentValues values, String whereClause, String[] whereArgs) {
        ...
        int numOfChangedRows = db.update(SIMPLETABLE, values, whereClause, whereArgs);
        return numOfChangedRows;
    }
    @Override
    public int delete(Uri uri, String whereClause,
                      String[] whereArgs) {
        int numOfChangedRows = db.delete(SIMPLETABLE, whereClause, whereArgs);
        return numOfChangedRows;
    }
    @Override
    public Cursor query(Uri uri, String[] columns, String whereClause, String[] whereArgs,
        ...
        // remember the
        if (code == 1) {
            cursor = db.query(SIMPLETABLE, columns, whereClause, whereArgs, null, null, sortOrder);
